...
class Render:
    ...
    def __call__(self, trajectory):
        ...
        for timeStep in range(len(trajectory)):
            ...
            if self.saveImage:
                picPath=os.path.join(self.demoFolder,'rope'+str(timeStep)+'.png')
                buffer = pyglet.image.get_buffer_manager().get_color_buffer().save(picPath)
