...
def main():
    ...
    modelFolder = os.path.join(mainModelFolder, 'expTrajMADDPGMujocoEnvWithRopeAdd2Distractors','damping={}_frictionloss={}_masterForce={}'.format(damping,frictionloss,masterForce))
