...
def main():
    ...
    modelFolder = os.path.join(mainModelFolder, 'originEnv9.16', 'indvidulReward={}_sheepWolfForceRatio={}_killZoneRatio={}_maxRange={}_sizeRatio={}'.format(individualRewardWolf, sheepWolfForceRatio, killZoneRatio, maxRange, sizeRatio), '{} wolves, {} sheep, {} blocks'.format(numWolves, numSheeps, numBlocks))
