...
def main():
    ...
    if debug:
        ...
        wolfMass = float(condition['wolfMass'])
        maxTimeStep = 25
        visualize=False
        saveAllmodels = True
    ...
    modelFolder = os.path.join(mainModelFolder, 'expTrajMADDPGMujocoEnvOct','damping={}_frictionloss={}_killZoneRatio{}_masterForce={}_masterMass={}_ropeLength={}_ropePunishWeight={}_sheepForce={}_wolfMass={}'.format(damping,frictionloss,killZoneRatio,masterForce,masterMass,ropeLength,ropePunishWeight,sheepForce,wolfMass))
...
#
    ...
    physicsDynamicsPath=os.path.join(dirName,'..','..','env','xml','leased2Distractor_masterMass={}_ropeLength={}_wolfMass={}.xml'.format(masterMass,ropeLength,wolfMass))
