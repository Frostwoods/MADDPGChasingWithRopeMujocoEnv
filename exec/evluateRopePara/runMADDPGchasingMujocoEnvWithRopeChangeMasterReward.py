...
def main():
    ...
    modelFolder = os.path.join(mainModelFolder, 'expTrajMADDPGMujocoEnvNovModifyMasterReward','damping={}_frictionloss={}_killZoneRatio{}_killZoneRatioofDistractor{}_masterForce={}_masterMass={}_ropeLength={}_ropePunishWeight={}'.format(damping,frictionloss,killZoneRatio,distractKillZoneRatio,masterForce,masterMass,ropeLength,ropePunishWeight))
