...
def generateSingleCondition(condition):
    ...
    modelFolder = os.path.join(mainModelFolder, modelSaveName,'damping={}_frictionloss={}_killZoneRatio{}_killZoneRatioofDistractor{}_masterForce={}_masterMass={}_ropeLength={}_ropePunishWeight={}'.format(damping,frictionloss,killZoneRatio,distractKillZoneRatio,masterForce,masterMass,ropeLength,ropePunishWeight))
    ...
    for hideId in hideIdList:
        ...
        if saveTraj:
            ...
            expTrajectoriesSaveDirectory = os.path.join(dataFolder, 'Exptrajectory', modelSaveName,'noiseOffsetMasterForSelectOct122')
